...
#include "my_ros2_interfaces/msg/detail/robot_status__rosidl_typesupport_fastrtps_c.h"
...
using _RobotStatus__ros_msg_type = my_ros2_interfaces__msg__RobotStatus;
...
size_t get_serialized_size_my_ros2_interfaces__msg__RobotStatus(
  const void * untyped_ros_message,
...
static uint32_t _RobotStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_ros2_interfaces__msg__RobotStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_ros2_interfaces
size_t max_serialized_size_my_ros2_interfaces__msg__RobotStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_ros2_interfaces__msg__RobotStatus;
    is_plain =
      (
...
static size_t _RobotStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_ros2_interfaces__msg__RobotStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_ros2_interfaces, msg, RobotStatus)() {
