...
#include "my_ros2_interfaces/msg/detail/robot_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_ros2_interfaces::msg::RobotStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_ros2_interfaces::msg::RobotStatus & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_ros2_interfaces::msg::RobotStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_ros2_interfaces::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_ros2_interfaces::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  return &my_ros2_interfaces::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_ros2_interfaces, msg, RobotStatus)() {
  return &my_ros2_interfaces::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
