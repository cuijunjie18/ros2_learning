...
bool rm_interfaces__msg__objective__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_interfaces.msg._objective.Objective", full_classname_dest, 38) == 0);
  }
  rm_interfaces__msg__Objective * ros_message = _ros_message;
  {  // pts
    ...
    Py_ssize_t size = 5;
    geometry_msgs__msg__Point * dest = ros_message->pts;
...
PyObject * rm_interfaces__msg__objective__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_interfaces.msg._objective");
