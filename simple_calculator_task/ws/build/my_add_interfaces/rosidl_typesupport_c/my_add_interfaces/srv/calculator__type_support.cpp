...
static const _Calculator_Request_type_support_symbol_names_t _Calculator_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_add_interfaces, srv, Calculator_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_add_interfaces, srv, Calculator_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_add_interfaces, srv, Calculator_Request)() {
  return &::my_add_interfaces::srv::rosidl_typesupport_c::Calculator_Request_message_type_support_handle;
}
...
static const _Calculator_Response_type_support_symbol_names_t _Calculator_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_add_interfaces, srv, Calculator_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_add_interfaces, srv, Calculator_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_add_interfaces, srv, Calculator_Response)() {
  return &::my_add_interfaces::srv::rosidl_typesupport_c::Calculator_Response_message_type_support_handle;
}
...
static const _Calculator_type_support_symbol_names_t _Calculator_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_add_interfaces, srv, Calculator)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_add_interfaces, srv, Calculator)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, my_add_interfaces, srv, Calculator)() {
  return &::my_add_interfaces::srv::rosidl_typesupport_c::Calculator_service_type_support_handle;
}
